...
`HUGO Gene Nomenclature Committee <https://www.ebi.ac.uk/services/teams/hgnc>`_ the scientific community have an
essential standardised nomenclature for human genes in hand. Because in many software projects a local installation with
fast programmatic access is required, we have developed a Python library which allows with very limited programming
skills to access and query HGNC data locally.
...
The content of HGNC and the use of PyHGNC supports
...
PyHGNC is an ongoing project and needs improvement. We are happy if you want support our project or start
